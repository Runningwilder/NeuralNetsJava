...
public class SigmoidNetwork {
	...
	/**
	 * 
	 * @param inputs - int[] of inputs - 1st layer also called the input layer
	 * @return int[] containing output from the network consisting of float numbers between 0 and 1
	 */
